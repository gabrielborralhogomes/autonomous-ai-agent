...
agent_runtime/
  ...
  core/
    __init__.py
    agent.py                  # ClaudeAutomationAgent (modo orchestrate)
    plan_execute_agent.py     # PlanExecuteAgent (modo plan_execute)
    context.py
    executor.py
    recovery.py
  registry/
  ...
  schemas/
    __init__.py
    prompt.py                 # SYSTEM_PROMPT para modo orchestrate
    plan_prompt.py            # PLAN_SYSTEM_PROMPT, VERIFY_SYSTEM_PROMPT, RECOVER_SYSTEM_PROMPT
    tool_schemas.py
  shared/
    __init__.py
    config.py
    ...
    providers/
      __init__.py
      base.py
      claude.py               # ClaudeProvider com prompt caching
      gemini.py
      openai_compat.py
      ollama_sdk.py
  tools/
